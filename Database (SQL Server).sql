...
create table SHARE_SOCIAL(
    ...
    share_user varchar(10),
    share_movie varchar(14)
)

create table FAVORITES(
    favorite_id int identity primary key,
    favorite_date datetime,
    favorite_user varchar(10),
    favorite_movie varchar(14)
)

create table MOVIES(
    movie_id varchar(14) primary key,
