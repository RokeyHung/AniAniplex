            ...
            <c:forEach items="${movies}" var="movie">
                <div class="anime-list-item">
                    ...
                    <div class="anime-item-content">
                        <a href="admin/edit?movieid=${movie.getMovieId()}" class="anime-item-nameVN">${movie.getMovieNameVn()}</a>
                    ...
                    <div class="anime-item-action">
                        <a href="admin/new-eposide?movieid=${movie.getMovieId()}" class="d-block anime-item-action-item">Thêm tập mới</a>
                        <a href="admin/edit?movieid=${movie.getMovieId()}" class="d-block anime-item-action-item">Chỉnh sửa</a>
                        <a href="admin/deleteMovie?movieid=${movie.getMovieId()}" class="d-block anime-item-action-item">Xoá</a>
                    </div>
                </div>
            </c:forEach>
        </div>
